...
============================================================================
Uses scikit-learn’s TfidfVectorizer with character 3–5-grams to build a
sparse vector index of all known degree aliases. Input strings are
vectorized and matched via cosine similarity.
...
if __name__ == "__main__":
    ...
    while True:
        print("\n" + "="*50)
        print("CV MANAGER NORMALIZATION CLI (TF-IDF Method)")
        print("="*50)
        ...
        if choice == '1':
            ...
            print("-" * 70)
            print(f"{'INPUT':<30} {'CANONICAL':<25} {'LAYER':<10} {'CONF':<6} {'STATUS'}")
            print("-" * 70)
            ...
            for r in results:
                ...
                print(f"{inp[:28]:<30} {canon[:23]:<25} {layer:<10} {conf:<6} {status}")
